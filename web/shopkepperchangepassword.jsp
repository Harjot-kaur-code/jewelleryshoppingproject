    ...
    <head>
        ...
        <script>
            ...
            function changepassword()
            {
                ...
                var skid = document.getElementById("skid").value;
                ...
                if (skid == "" || opassword == "" || npassword == "" || cpassword == "")
                {
                ...
                } else
                {
                    ...
                    var querystring = "skid=" + skid + "&opassword=" + opassword + "&npassword=" + npassword;
                    xhr.open("GET", "shopkeeperchangepassword?" + querystring, true);
                    xhr.send();
            ...
            <div class="container">
                ...
                <div class="login-form-grids">
                    ...
                    <form id="signupform">
                        ...
                        <%                            if (session.getAttribute("skid") != null) {
                        ...
                        <input type="text" placeholder="Enter Id" name="skid" id="skid"  value="<%=skid%>" required=" " >
