...
jQuery(document).ready(function ($) {
    $(".scroll").click(function (event) {
        ...
        <script>
            ...
            function shopkeepersignuplogic()
            {
                ...
                } else
                {
                    ...
                    xhr.onreadystatechange = function ()
                    {
                        if (xhr.readyState === 4 && xhr.status == 200)
                        {
                            ...
                            if (res == "success")
                            {
                                document.getElementById("shopkeepersignupresult").innerHTML = "Added successfuly...  You will get message when admin will approve you and then you will able to login ";
                                setInterval(gotoindex,2000);
                            } else
                            {
                                document.getElementById("shopkeepersignupresult").innerHTML = "User already exist";
        ...
        <div class="breadcrumbs">
            <div class="container">
                <ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
                    ...
                    <li class="active">Shopkeeper Register Page</li>
                </ol>
            </div>
        </div>
        <!-- //breadcrumbs -->
                ...
                <div class="login-form-grids">
                    ...
                    <form id="signupform">
                       ...
                       <input type="email" placeholder="Enter email" name="email" id="email" required=" " >
                        ...
                        <h4 id="shopkeepersignupresult"></h4>

                        <input type="button" onclick="shopkeepersignuplogic()" name="signupbutton"  value="Register">
                    </form>
