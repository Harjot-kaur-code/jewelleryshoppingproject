...
CREATE TABLE `productgallery` (
  ...
  PRIMARY KEY (`pgid`),
  KEY `fkkff_idx` (`pid`),
  CONSTRAINT `fkkff` FOREIGN KEY (`pid`) REFERENCES `products` (`pid`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `productgallery` VALUES (1,'abc','myuploads/1610003844959.jpg',15),(4,'nb','myuploads/1610004197927.jpg',15),(5,'m,n','myuploads/1610004206262.jpg',15);
